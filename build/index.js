...
function formatUcoPrice(priceData) {
...
// Tool: Get UCO Price
server.tool('getUcoPrice', 'Fetches the latest UCO price (USD and EUR) from the Archethic network oracle', {
    state: z.object({
        priceData: z.object({
            timestamp: z.number(),
            usd: z.number(),
...
export { getArchethicUcoPrice, ARCHETHIC_API_URL, UCO_PRICE_QUERY, };
